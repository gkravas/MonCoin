...
+ (BOOL)hideLatHUDAnimated:(BOOL)animated {
	if (lastHUD != nil) {
		lastHUD.removeFromSuperViewOnHide = YES;
		[lastHUD hide:animated];
        lastHUD = nil;
		return YES;
	}
	return NO;
...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes: @{NSFontAttributeName: [UIFont systemFontOfSize:label.font.lineHeight]}];
